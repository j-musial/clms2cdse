...
###############################
#release notes:
#Version 1.00 [20250318] - initial release code name charon
#Version 1.01 [20250331] - addition of batch upload example, additon of notification if upload fails
#Version 1.02 [20250406] - addition of gdal sanity test
###############################
version="1.02"
usage()
{
...
#Batch upload of all NetCDFs for dataset swe_5km_v2_daily residing localy in /home/ubuntu/webResources/catalogTree/netcdf/snow_water_equivalent/swe_5km_v2_daily:
...
#Batch upload of all tiff for dataset swe_5km_v2_daily residing localy in /home/ubuntu/webResources/catalogTree/netcdf/snow_water_equivalent/swe_5km_v2_daily
...
#Batch upload of all files residing localy in /home/ubuntu/webResources/catalogTree/netcdf/snow_water_equivalent/swe_5km_v2_daily
